...
public class QuiescenceListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request,
		...
		int listSize = dao.getQuserListCount(psCode, type, search); // 유저 수
		// 리스트 번호
		...
		String pagiNation = SMSUtil.makePagiNation(listSize, page, limit,
				"QuiescenceAction.ac", params);
		ArrayList<UserBean> list = (ArrayList<UserBean>) dao.getQuserList(
				search, start, limit, psCode, type);
